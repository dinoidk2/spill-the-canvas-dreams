  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center py-24 px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-0 right-0 w-96 h-96 bg-impression-pink opacity-10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-impression-blue opacity-10 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="max-w-4xl w-full mx-auto">
        <div className="paint-card">
          ...
          <div className="flex flex-col items-center justify-center space-y-8">
            <div className="relative w-40 h-40 sm:w-56 sm:h-56 rounded-full overflow-hidden animate-paint-pulse">
            ...
            <div className="text-center space-y-10 w-full max-w-xl">
              <div 
                className="relative p-6 bg-white rounded-xl shadow-lg transition-transform transform hover:scale-105"
                onClick={copyEmail}
              >
                <h2 className="text-3xl font-dancing text-impression-purple mb-2">Email</h2>
                <div className="flex items-center justify-center gap-2">
                  ...
                  <p className="text-xl">oceanaviktorial@gmail.com</p>
                </div>
              ...
              <div className="relative p-6 bg-white rounded-xl shadow-lg transition-transform transform hover:scale-105">
                <h2 className="text-3xl font-dancing text-impression-blue mb-2">Social Media</h2>
                <div className="flex items-center justify-center gap-2">
                  ...
                  <p className="text-xl">@oceanaviktoria.nebre</p>
                </div>
              </div>
